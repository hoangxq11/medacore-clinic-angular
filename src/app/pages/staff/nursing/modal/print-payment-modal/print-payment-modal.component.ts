...
@Component({
  selector: 'app-print-payment-modal',
  templateUrl: './print-payment-modal.component.html',
  styleUrls: ['./print-payment-modal.component.scss']
})
export class PrintPaymentModalComponent implements OnInit {
  @Input() medicalRecordDto!: MedicalRecordDto;
  @Input() listServiceOfMedicalTestDto!: ServicesOfMedicalTestDto[];
  ...
  ngOnInit(): void {
    this.listServiceOfMedicalTestDto.forEach(e => this.totalPrice += e.serviceDto.price * e.quantity);
