...
@Component({
  selector: 'app-print-medical-test',
  templateUrl: './print-medical-test.component.html',
  styleUrls: ['./print-medical-test.component.scss']
})
export class PrintMedicalTestComponent {
