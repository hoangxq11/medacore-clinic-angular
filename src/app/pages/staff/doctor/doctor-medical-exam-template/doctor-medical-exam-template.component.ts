...
@Component({
  selector: 'app-doctor-medical-exam-template',
  templateUrl: './doctor-medical-exam-template.component.html',
  styleUrls: ['./doctor-medical-exam-template.component.scss']
})
export class DoctorMedicalExamTemplateComponent {
  total = 1;
  ...
  getListTemplate(): void {
    this.templateService.getTemplatesOfDoctor(this.doctorUsername).subscribe(data => {
  ...
  showModalCreateTemplate(): void {
    ...
    (<ModalCreateMedicalExamTemplateComponent>modal.componentInstance).doctorUsername = this.doctorUsername;
